...
public class CommentService {
    ...
    public void deleteComment(Long postId, Long commentId) {
        ...
        //orphanRemoval 안했을 때(기본값 : false), 연관관계 주인(One) 쪽에서 없애는 코드 있으면 그때 영속성이 관리한다면 UPDATE 쿼리 나감.(post_id만 null 처리)
...
//        commentRepository.delete(commentId); //comment 레코드 자체를 제거. -> post_id 외래 키도 함께 사라짐.
        /*
        최적화 : update, delete 문 둘 다 같이 나가지 않음. update 외래키 null 예약하고, delete comment_id 있으면 delete만 보내서 하는 식으로
        JPA 가 최적화 실행.
        */
    }
